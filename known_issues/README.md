...
When creating the folder that contains the Swift/ folder (e.g. 3C_273/) you need to ensure that the **folder name** only contains **UNICODE characters**. You will have issues with DS9 otherwise.
